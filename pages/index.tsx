      ...
      <div className="bodyasli bg-slate-100">
        ...
        <div className=" pb-6 ">
          ...
          <div className={styles.main}>
            ...
            <div className="mt-10 ">
              <Link href="/event">
                <button className="bg-[#504CD8]  hover:bg-slate-700 rounded-full font-semibold text-white py-2 px-4 border  hover:border-transparent ">Discover More Events</button>
              </Link>
            </div>
          </div>
        </div>
