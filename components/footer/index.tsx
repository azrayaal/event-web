      ...
      <footer className="p-4 dark:bg-white sm:p-6 hidden sm:block bg-gray-800">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols- gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
              <h3 className="mb-6 text-sm font-semibold dark:text-gray-900 uppercase text-gray-200">Follow us</h3>
              <ul>
                <li className="mb-4">
            ...
            <div>
              <h3 className="mb-6 text-sm font-semibold dark:text-gray-900 uppercase text-gray-200">Legal</h3>
              <ul>
                <li className="mb-4">
                  <a href="#" target="_blank" className="dark:text-gray-600 hover:underline text-gray-400">
                    Privacy Policy
